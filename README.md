...
3. [Key Components of an Ansible Role](#key-components-of-an-ansible-role)
    ...
    6. [Defaults](#defaults)
    7. [Meta](#meta)
4. [Why Use Ansible Roles? 🚀](#why-use-ansible-roles-)
    1. [Modularity 🧩](#modularity-)
    2. [Reusability 🔄](#reusability-)
    3. [Shareability 🌍](#shareability-)
    4. [Maintainability 🛠️](#maintainability-)
    5. [Consistency 🔄](#consistency-)
5. [Purpose of Ansible Roles 🎯](#purpose-of-ansible-roles-)
6. [Prerequisites for Using Ansible Roles ⚙️](#prerequisites-for-using-ansible-roles-)
