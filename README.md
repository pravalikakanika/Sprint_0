...
6. [Key Components of an Ansible Role](#key-components-of-an-ansible-role)
    ...
    6. [Defaults](#defaults)
    7. [Meta](#meta)
7. [Why Use Ansible Roles?](#why-use-ansible-roles-1)
    1. [Modularity](#modularity)
    2. [Reusability](#reusability)
    3. [Shareability](#shareability)
    4. [Maintainability](#maintainability)
    5. [Consistency](#consistency)
8. [Purpose of Ansible Roles](#purpose-of-ansible-roles)
9. [Prerequisites for Using Ansible Roles](#prerequisites-for-using-ansible-roles)
...
10. [Features of Ansible Roles](#features-of-ansible-roles)
